...
getStartChars s = case true of
  _
    | startsWith "one" s -> Just (Tuple 1 (drop 1 s))
  _
    | startsWith "two" s -> Just (Tuple 2 (drop 1 s))
  _
    | startsWith "three" s -> Just (Tuple 3 (drop 1 s))
  _
    | startsWith "four" s -> Just (Tuple 4 (drop 1 s))
  _
    | startsWith "five" s -> Just (Tuple 5 (drop 1 s))
  _
    | startsWith "six" s -> Just (Tuple 6 (drop 1 s))
  _
    | startsWith "seven" s -> Just (Tuple 7 (drop 1 s))
  _
    | startsWith "eight" s -> Just (Tuple 8 (drop 1 s))
  _
    | startsWith "nine" s -> Just (Tuple 9 (drop 1 s))
  _ -> Nothing

getFirstLast :: String -> Int
getFirstLast line = aux line (Tuple Nothing Nothing)
  where
